...
export const INVALID_MODULE_ERROR =
  'An invalid module was passed in the list of modules';
...
export class ModuleWalker {
  ...
  walk(modules: Array<ModuleType | ExtendedModule>) {
    ...
    modules.forEach((mod) =>
      this.innerWalk(mod, (module) => result.push(module))
    );
