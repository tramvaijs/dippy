...
describe('createToken', () => {
  ...
  it('token with object type', () => {
    ...
    expectTypeOf<ExtractTokenType<typeof TOKEN>>()
      .toHaveProperty('foo')
      .toBeString();
    expectTypeOf<ExtractDependencyType<typeof TOKEN>>(TOKEN)
      .toHaveProperty('foo')
      .toBeString();
  });
  ...
  it('multi token with primitive type', () => {
    ...
    expectTypeOf<ExtractDependencyType<typeof TOKEN>>().toEqualTypeOf<
      number[]
    >();
  });
  ...
  it('multi token with object type', () => {
    ...
    expectTypeOf<ExtractTokenType<typeof TOKEN>>()
      .toHaveProperty('foo')
      .toBeString();
    expectTypeOf<ExtractDependencyType<typeof TOKEN>[0]>()
      .toHaveProperty('foo')
      .toBeString();
  });
